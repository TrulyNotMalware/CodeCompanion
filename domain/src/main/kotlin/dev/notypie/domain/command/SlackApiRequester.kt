...
interface SlackApiRequester {
    ...
    fun simpleEphemeralErrorTextRequest(markdownErrorMessage: String, commandBasicInfo: CommandBasicInfo, commandType: CommandType, commandDetailType: CommandDetailType): SlackApiResponse
