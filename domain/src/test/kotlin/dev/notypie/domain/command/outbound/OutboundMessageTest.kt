                ...
                then("fields round-trip") {
                    val reschedule =
                        ModalForm.Reschedule(
                            ...
                            requesterId = "U1",
                            currentStartAt = LocalDateTime.of(2026, 1, 1, 9, 0),
                        )
                    reschedule.meetingUid shouldBe meetingUid
                    reschedule.requesterId shouldBe "U1"
                    reschedule.currentStartAt shouldBe LocalDateTime.of(2026, 1, 1, 9, 0)

                    val addParticipant = ModalForm.AddParticipant(meetingUid = meetingUid, requesterId = "U2")
                    ...
                    val standupSetup = ModalForm.StandupSetup(creatorId = "U4")
        ...
        given("each OutboundMessage variant") {
            ...
            `when`("constructed") {
                then("fields round-trip") {
                    ...
                    val form = ModalForm.StandupSetup(creatorId = "U9")
