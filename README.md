...
## Tech Stack
- **Kotlin** (v2.3.0-RC) & **Spring Boot** (v4.0.0)
- **Java** (v25)
- **Clean Architecture**:
...
3. **Set up development environment**
    - **Configure Gradle properties**
      ```
      ./gradle-config/apply.sh
      ```
    - **Add Ktlint pre-commit hook for code linting**
      ```
...
3. **개발 환경 설정**
    - **Gradle 속성 설정**
      ...
      ./gradle-config/apply.sh
      ```
    - **코드 린팅을 위한 Ktlint pre-commit hook 추가**
      ```
      ./gradlew addKtlintCheckGitPreCommitHook
      ```
